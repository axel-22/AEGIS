...
class USERS(Base):
    ...
    NONCES: Mapped[list['NONCES']] = relationship('NONCES', back_populates='USERS_')


class BADGES(Base):
    __tablename__ = 'BADGES'

    header_id: Mapped[str] = mapped_column(String(100), nullable=False)
...
class VOTES(Base):
    ...
    is_boolean: Mapped[bool] = mapped_column(Boolean, nullable=False)
    vote_type: Mapped[str] = mapped_column(String(100), nullable=False)
    is_active: Mapped[bool] = mapped_column(Boolean, nullable=False)
    vote_id: Mapped[Optional[int]] = mapped_column(Integer, primary_key=True)
    description_text: Mapped[Optional[str]] = mapped_column(String(1000))
    creator_user_id: Mapped[Optional[int]] = mapped_column(ForeignKey('USERS.user_id'))
    vote_mode: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    vote_result: Mapped[Optional[str]] = mapped_column(String(1000))
...
class ENVELOPES(Base):
    ...
    vote_choice: Mapped[int] = mapped_column(Integer, nullable=False)
    ...
    BADGES_: Mapped[Optional['BADGES']] = relationship('BADGES', back_populates='ENVELOPES')
